...
# Windows and Android do not include zoneinfo files, so bundle the tzinfo-data gem 
if ['mingw', 'mswin', 'x64_mingw', 'jruby'].include?(RUBY_PLATFORM) || RUBY_PLATFORM.include?('arm-linux')
  gem 'tzinfo-data'
end
